...
var ChangeDetector = /** @class */ (function () {
    ...
    ChangeDetector.prototype.addModule = function (module) {
        return __awaiter(this, void 0, void 0, function () {
            var modules, _i, modules_1, moduleName, moduleInfo, moduleComponents, error_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        modules = typeof module === 'string' ? [module] : module;
                        _i = 0, modules_1 = modules;
                        _b.label = 1;
                    case 1:
                        if (!(_i < modules_1.length)) return [3 /*break*/, 6];
                        moduleName = modules_1[_i];
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        moduleInfo = this.findAppFile(moduleName, "module");
                        return [4 /*yield*/, this.extractComponentsFromModule(moduleInfo)];
                    case 3:
                        moduleComponents = _b.sent();
    ...
    ChangeDetector.prototype.addComponent = function (component) {
        return __awaiter(this, void 0, void 0, function () {
            var components, _i, components_1, componentName, componentInfo;
            return __generator(this, function (_a) {
                components = typeof component === 'string' ? [component] : component;
                for (_i = 0, components_1 = components; _i < components_1.length; _i++) {
                    componentName = components_1[_i];
                    try {
                        componentInfo = this.findAppFile(componentName, "component");
    ...
    ChangeDetector.prototype.extractComponentsFromModule = function (moduleInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var lineReader, lineObj, line, components, imprtArr, componentName, componentInfo;
            return __generator(this, function (_a) {
                lineReader = new lineByLine(moduleInfo.fullPath);
                components = [];
                if (this.verbose)
                ...
                while (lineObj = lineReader.next()) {
                    ...
                    if (line.includes("import") && line.includes("from") && line.includes(".component")) {
                        imprtArr = line.split('/');
                        componentName = "" + imprtArr[imprtArr.length - 1].replace(".component", "").replace(/[^a-zA-Z\-\.]/g, "");
                        componentInfo = this.findAppFile(componentName, "component");
                        if (this.verbose)
