...
var ChangeDetector = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.trys.push([2, 5, , 6]);
                        return [4 /*yield*/, this.findFile(path, moduleName + ".module.ts")];
                    case 3:
                        moduleInfo = _b.sent();
    ...
    ChangeDetector.prototype.addComponent = function (component) {
        return __awaiter(this, void 0, void 0, function () {
            var components, _i, components_1, componentName, componentInfo, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.findFile(path, componentName + ".component.ts")];
                    case 3:
                        componentInfo = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        fileInfo = _a.sent();
                        if (this.verbose)
                            console.log(" *", fileInfo.basename.replace(".ts", ""));
